...
QT_MOC_LITERAL(1, 6, 15), // "OnEventLoopQuit"
...
QT_MOC_LITERAL(5, 52, 5) // "reply"
    ...
    "Robot\0OnEventLoopQuit\0\0replyFinished\0"
...
void Robot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnEventLoopQuit(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Robot::OnEventLoopQuit)) {
                *result = 0;
                return;
            }
        }
...
void *Robot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "RobotInterface"))
        return static_cast< RobotInterface*>(const_cast< Robot*>(this));
    if (!strcmp(_clname, "org.qt-project.Qt.RobotInterface"))
        return static_cast< RobotInterface*>(const_cast< Robot*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    '.',  'Q',  't',  '.',  'R',  'o',  'b',  'o', 
    't',  'I',  'n',  't',  'e',  'r',  'f',  'a', 
    'c',  'e',  0x00, 0x00, 0x9b, 0x09, 0x00, 0x00,
    0x09, 0x00, 'c',  'l',  'a',  's',  's',  'N', 
    'a',  'm',  'e',  0x00, 0x05, 0x00, 'R',  'o', 
    'b',  'o',  't',  0x00, 0x1a, 0x00, 0xa1, 0x00,
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    '.',  'Q',  't',  '.',  'R',  'o',  'b',  'o', 
    't',  'I',  'n',  't',  'e',  'r',  'f',  'a', 
    'c',  'e',  0x00, 0x00, 0x95, 0x09, 0x00, 0x00,
    0x08, 0x00, 'M',  'e',  't',  'a',  'D',  'a', 
    't',  'a',  0x00, 0x00, 0x0c, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x1b, 0x0d, 0x00, 0x00, 0x09, 0x00, 'c',  'l', 
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x05, 0x00, 'R',  'o',  'b',  'o',  't',  0x00,
...
QT_MOC_EXPORT_PLUGIN(Robot, Robot)
